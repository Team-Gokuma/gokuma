      ...
      <Intro>이미지 처리 인공지능 웹 서비스 '어쩔 냉장고'를 만든 Team Gokuma입니다!</Intro>
        <Members>
          <Profile
            ...
            part="백엔드 / AI"
            intro="팀의 빛과 소금!"
            // 제가 해결하지 못하는 문제는 없습니다. 끝까지 파고들어 해결해낸다! 자네는 백엔드의 신이야
          ...
          <Profile
            ...
            part="백엔드 / 프론트엔드"
            intro="풀스택은 실재한다!"
            // 백엔드와 프론트엔드를 오가며 양쪽의 문제상황을 이해시켜주는 자네는 코로나 확진자야
          ...
          <Profile
            ...
            part="프론트엔드"
            intro="이 시대의 진정한 리더!"
            // 걱정인형이지만 그 덕에 모두 완성해 내는 자네는 디자인의 신이야
            git=""
          />
          <Profile
            image={hoo}
            name="전현호"
            part="AI"
            intro="팀 이름은 제가 지었습니다~"
            // 인공지능과 데이터에 대한 지식이 뛰어난 자네가 없었다면 어쩔냉장고는 없었네 자네는 데이터의 신이야
          ...
          <Profile
            ...
            part="AI"
            intro="데이터를 지배하는 자!"
            // 냉철한 시각으로 인공지능의 성능을 최대로 끌어내는 능력을 가진 자제는 인공지능의 신이야
